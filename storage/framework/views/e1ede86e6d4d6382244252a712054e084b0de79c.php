...
<html lang="en">
    ...
    <body id="page-top">
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item"><a class="nav-link" href="register">UserRegister</a></li>
                        <li class="nav-item"><a class="nav-link" href="userlogin">UserLogin</a></li>
        ...
        <header class="mastheads">
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                ...
                <div class="wrapper">
    <div class="logo"> <img src="assets/img/admin.png" alt=""> </div>
    <div class="text-center mt-4 name"> Admin login</div>
    <form class="p-3 mt-3" method="post" action="/adminlogins">
    <?php echo csrf_field(); ?>
    ...
    <!--<div class="text-center fs-6"> <a href="#"><a href="#">Sign up</a> </div> -->
</div>
                    </div>
                </div>
...
<?php /**PATH D:\laravel\summercamp\resources\views/admin/header.blade.php ENDPATH**/ ?>