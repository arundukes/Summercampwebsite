            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        <h1 class="mx-auto my-0 text-uppercase">SummerCamp</h1>
                        <h2 class="text-white-50 mx-auto mt-2 mb-5">PEAKS camp offers all the fun and educational benefits of regular summer camp
programs, from the comfort of your home</h2>
...
<?php /**PATH D:\laravel\summercamp\resources\views/user/header.blade.php ENDPATH**/ ?>